(function () {
  ...
  const searchTargets = [
    ...
    { label: "P01 Stainless Steel Milanese Loop Apple Watch Band", type: "Product page", href: "products/p01-stainless-steel-milanese-loop-apple-watch-band/", description: "P01 stainless steel Milanese Loop Apple Watch band with magnetic clasp, 630 stainless steel material, 22mm band width, Apple Watch 38/40/41mm and 42/44/45/49mm fit review and BOORUI packaging support.", keys: ["p01", "milanese", "milanese loop", "magnetic clasp", "630 stainless steel", "apple milanese", "stainless steel apple watch band", "22mm", "38mm", "40mm", "41mm", "42mm", "44mm", "45mm", "49mm"] },
    { label: "P02 Convertible Jewelry Chain Smartwatch Band", type: "Product page", href: "products/p02-convertible-jewelry-chain-smartwatch-band/", description: "P02 jewelry chain smartwatch band with convertible connector support for Apple Watch, Huawei Band 11, Huawei Band 11 Pro, Huawei Fit 1-4, 18mm, 20mm, 22mm and OPPO Watch X2 Mini sourcing.", keys: ["p02", "jewelry chain", "fashion band", "bow band", "rhinestone", "apple watch jewelry band", "huawei band 11", "huawei band 11 pro", "huawei fit", "huawei fit 1", "huawei fit 2", "huawei fit 3", "huawei fit 4", "oppo watch x2 mini", "18mm", "20mm", "22mm"] },
