(function () {
  ...
  function initSiteSearch() {
    ...
    form.innerHTML = `
      <label class="sr-only" for="boorui-site-search">Search BOORUI categories</label>
      <input id="boorui-site-search" type="search" name="q" list="boorui-search-suggestions" placeholder="Search categories" autocomplete="off" aria-label="Search BOORUI categories" />
